...
a persistence unit "facturacionTechShopPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "facturacionTechShop/pom.xml":
...
artifact ("facturacionTechShop.war") is already built. You can build
